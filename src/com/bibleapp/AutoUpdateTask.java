...
class AutoUpdateTask extends AsyncTask<Long, Void, String> {
    ...
    private final static String GET_BUNDLE_URL = "https://upd.appery.io/update/dc959d51-57e7-496a-90fd-4430ee8777a2.zip";
    
    private final static Long BUILD_TIMESTAMP_MILLISEC = 1472271746 * 1000L;
